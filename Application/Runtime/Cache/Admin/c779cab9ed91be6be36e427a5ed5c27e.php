        ...
        <div class="widget">
            ...
            <div class="widget-body">
                <div class="tree well">
                	...
                	<span><sup style="font-size:1em;">* "红色"代表会员数量</sup></span><br />
                	<span><sup style="font-size:1em;">* 订单量为该会员及其下线所有订单量的总和</sup></span> -->
                	<hr />
                    <ul>
                        <?php if(is_array($cache)): $i = 0; $__LIST__ = $cache;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if(($vo["type"]) == "1"): ?><li id="node<?php echo ($vo["id"]); ?>" data-id="<?php echo ($vo["id"]); ?>" class="parent">
                                    ...
                                    <span class="numPer redCol"><?php echo ($vo["count1"]); ?></span><span class="numPer rouCol"><?php echo ($vo["ocount"]); ?>单：共计<?php echo ($vo["osum"]); ?></span>
