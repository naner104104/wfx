        ...
        <div class="widget">
            ...
            <div class="widget-body">
                <div class="table-toolbar">
                    <a href="<?php echo U('Admin/Shop/groupbuySet/');?>" class="btn btn-primary" data-loader="App-loader" data-loadername="设置团购商品">
                        <i class="fa fa-plus"></i>新增团购
                    </a>
                    ...
                    <div class="pull-right">
                        <form id="App-search">
                            ...
                            <a href="<?php echo U('Admin/Shop/groupbuy/');?>" class="btn btn-success" data-loader="App-loader" data-loadername="商品" data-search="App-search">
                ...
                <table id="App-table" class="table table-bordered table-hover">
                    ...
                    <tbody>
                        <?php if(is_array($cache)): $i = 0; $__LIST__ = $cache;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr id="item<?php echo ($vo["id"]); ?>">
                                ...
                                <td class=" "><?php echo ($vo["ptid"]); ?></td>
                                <td class=" "><?php echo ($vo["price"]); ?></td>
                                <td class=" "><?php echo ($vo["sorts"]); ?></td>
                                <td class=" "><?php echo ($vo["minnumber"]); ?></td>
                                <td class=" "><?php echo ($vo["buygoodsnum"]); ?></td>
                                <td class=" "><?php echo ($vo["zan"]); ?></td>
                               <!--  <td class=" "><?php echo ($vo["indate"]); ?></td> -->
                                                         
                                <td class="center "><a href="<?php echo U('Admin/Shop/groupbuySet/',array('id'=>$vo['id']));?>" class="btn btn-success btn-xs" data-loader="App-loader" data-loadername="设置商品"><i class="fa fa-edit"></i> 管理</a>&nbsp;&nbsp;<a href="<?php echo U('Admin/Shop/groupbuy/');?>" class="btn btn-danger btn-xs" data-type="del" data-ajax="<?php echo U('Admin/Shop/groupbuyDel/',array('id'=>$vo['id']));?>"><i class="fa fa-trash-o"></i> 删除</a></td>
...
$('#App-delall').on('click', function() {
    ...
    var toajax = "<?php echo U('Admin/Shop/groupbuyDel');?>" + "/id/" + chk;
    var funok = function() {
        var callok = function() {
            //成功删除后刷新
