    ...
    <div class="col-xs-12 col-xs-12">
        <div class="widget radius-bordered">
            <div class="widget-header bg-blue">
                ...
                <span class="widget-caption">团购商品设置</span>
            ...
            <div class="widget-body">
                <form id="AppForm" action="" method="post" class="form-horizontal" data-bv-message="" data-bv-feedbackicons-valid="glyphicon glyphicon-ok" data-bv-feedbackicons-invalid="glyphicon glyphicon-remove" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh">
                    ...
                    <div class="form-title">
                        <a href="<?php echo U('Admin/Shop/groupbuy/');?>" class="btn btn-primary" data-loader="App-loader" data-loadername="团购管理">
                            <i class="fa fa-mail-reply"></i>返回
                        </a>
                    </div>
                    
                    <div class="form-group">
                        <label class="col-lg-2 control-label">商品ID<sup>*</sup></label>
                        <div class="col-lg-4">
                            <input type="text" class="form-control" name="ptid" placeholder="必填" data-bv-notempty="true" data-bv-notempty-message="不能为空" value="<?php echo ($cache["ptid"]); ?>">
                        </div>
                    </div>
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        <label class="col-lg-2 control-label">团购限量<sup>*</sup></label>
                        <div class="col-lg-4">
                            <input type="text" class="form-control" name="minnumber" placeholder="必填" data-bv-notempty="true" data-bv-notempty-message="不能为空" value="<?php echo ($cache["minnumber"]); ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-2 control-label">已团购件</label>
                        <div class="col-lg-4">
                            <input type="text" class="form-control" name="buynumber" placeholder="不填" value="<?php echo ($cache["buygoodsnum"]); ?>" disabled="true">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-2 control-label">点赞人数</label>
                        <div class="col-lg-4">
                            <input type="text" class="form-control" name="zan" placeholder="不填" value="<?php echo ($cache["zan"]); ?>" disabled="true">
                        </div>
                    </div>
                    <!-- <div class="form-group">
                        <label class="col-lg-2 control-label">截止时间</label>
                        <div class="col-lg-4">
                            <input type="datetime-local" class="form-control" name="indate" placeholder="必填" data-bv-notempty="true" data-bv-notempty-message="不能为空" value="<?php echo ($cache["indate"]); ?>">
                        </div>
                    </div> -->
                    <div class="form-group">
...
$('#AppForm').bootstrapValidator({
    submitHandler: function(validator, form, submitButton) {
        ...
        $('#lid').val(lid);
        var tourl = "<?php echo U('Admin/Shop/groupbuySet');?>";
