	...
	<div class="col-xs-12 col-md-12">
		<div class="widget">
			<div class="widget-header bg-blue">
				...
				<span class="widget-caption">推广日志</span>
				...
				<div class="table-toolbar">
					...
					<div class="pull-right">
						<form id="App-search">
							...
							<a href="<?php echo U('Admin/Log/tj/');?>" class="btn btn-success" data-loader="App-loader" data-loadername="推广日志" data-search="App-search">
				...
				<table id="App-table" class="table table-bordered table-hover">
					...
					<tbody>
						<?php if(is_array($cache)): $i = 0; $__LIST__ = $cache;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr id="item<?php echo ($vo["id"]); ?>">
								...
								<td class=" "><?php echo ($vo["xxnickname"]); ?></td>
