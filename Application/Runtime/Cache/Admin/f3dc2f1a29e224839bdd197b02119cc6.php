...
<body class="goodbycate">
    <div>
        <div>
                    <form id="App-search" method="post" action="<?php echo U('Admin/Shop/test/');?>">
        ...
        <div class="index-plist ovflw" id="index-plist">
                <ul class="plist-ul ovflw">
                    <?php if(is_array($goodlist)): $i = 0; $__LIST__ = $goodlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
