        ...
        <div class="widget">
            ...
            <div class="widget-body">
                <div class="table-toolbar">
                    <a href="<?php echo U('Admin/Shop/cateSet/');?>" class="btn btn-primary" data-loader="App-loader" data-loadername="设置分类">
                    ...
                    <div class="pull-right">
                        <form id="App-search">
                            ...
                            <a href="<?php echo U('Admin/Shop/cate/');?>" class="btn btn-success" data-loader="App-loader" data-loadername="商城分类" data-search="App-search">
...
<!--                                     <td class=" "><?php echo ($vo2["pid"]); ?></td>
                                    ...
                                    <td class="center "><a href="<?php echo U('Admin/Shop/cateSet/',array('id'=>$vo2['id']));?>" class="btn btn-success btn-xs" data-loader="App-loader" data-loadername="设置分类"><i class="fa fa-edit"></i> 编辑</a>
                                ...
                                <?php if(is_array($vo2['_child'])): foreach($vo2['_child'] as $key=>$vo3): ?><tr id="item<?php echo ($vo3["id"]); ?>">
                                        ...
                                        <td class="center "><a href="<?php echo U('Admin/Shop/cateSet/',array('id'=>$vo3['id']));?>" class="btn btn-success btn-xs" data-loader="App-loader" data-loadername="设置分类"><i class="fa fa-edit"></i> 编辑</a>
                                    ...
                                    <?php if(is_array($vo3['_child'])): foreach($vo3['_child'] as $key=>$vo4): ?><tr id="item<?php echo ($vo4["id"]); ?>">
                                            ...
                                            <td class="center "><a href="<?php echo U('Admin/Shop/cateSet/',array('id'=>$vo4['id']));?>" class="btn btn-success btn-xs" data-loader="App-loader" data-loadername="设置分类"><i class="fa fa-edit"></i> 编辑</a>
                                        ...
                                        <?php if(is_array($vo4['_child'])): foreach($vo4['_child'] as $key=>$vo5): ?><tr id="item<?php echo ($vo5["id"]); ?>">
                                                ...
                                                <td class="center ">
                                                    <a href="<?php echo U('Admin/Shop/cateSet/',array('id'=>$vo5['id']));?>" class="btn btn-success btn-xs" data-loader="App-loader" data-loadername="设置分类"><i class="fa fa-edit"></i> 编辑</a>
