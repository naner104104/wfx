...
<body class="back2 color6">
		<div class="bsk-hd ovflw">
			...
			<span class="fr ads-btn fonts9 back3" style="display: block;text-align: center;border-radius: 3px;line-height: 10px" id="clearbasket"><i class="iconfont">&#xe6b4</i>清空</span>
		</div>
		<div class="bsk-cc">
			<div class="border-t1">
