...
<body class="back1">
		<div class="ads-tabs ovflw">
			<a href="<?php echo U('App/Vip/orderList',array('sid'=>0,'type'=>4));?>" class="fl text-c"><span <?php if(($type) == "4"): ?>class='active'<?php endif; ?>>全部</span></a>
			<a href="<?php echo U('App/Vip/orderList',array('sid'=>0,'type'=>1));?>" class="fl text-c "><span <?php if(($type) == "1"): ?>class='active'<?php endif; ?>>待付款</span></a>
			<a href="<?php echo U('App/Vip/orderList',array('sid'=>0,'type'=>2));?>" class="fl text-c"><span <?php if(($type) == "2"): ?>class='active'<?php endif; ?>>待收货</span></a>
			<a href="<?php echo U('App/Vip/orderList',array('sid'=>0,'type'=>3));?>" class="fl text-c"><span <?php if(($type) == "3"): ?>class='active'<?php endif; ?>>已完成</span></a>
		</div>
		<div class="ads-cc">
		<?php if(is_array($cache)): $i = 0; $__LIST__ = $cache;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="ads-lst border-b1 ovflw mr-b back2 color6">
				<p class="ads-tt border-b1"><?php echo ($vo["oid"]); ?>&nbsp;&nbsp;&nbsp;<?php switch($vo["buytype"]): case "0": ?>普通订单<?php break; case "1": ?>团购订单<?php break; endswitch;?>
		...
		<div class="dtl-ft ovflw">
			<div class=" fl dtl-icon dtl-bck ovflw order-dtl">
