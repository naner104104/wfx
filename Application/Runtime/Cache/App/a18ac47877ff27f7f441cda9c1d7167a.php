...
<body class="back1">
    ...
    <div class="ads-tabs ovflw">
                <a href="<?php echo U('App/Vip/orderList',array('sid'=>0,'type'=>4));?>" class="fl text-c color6"><span <?php if(($type) == "4"): ?>class='active'<?php endif; ?>>全部</span></a>
                <a href="<?php echo U('App/Vip/orderList',array('sid'=>0,'type'=>1));?>" class="fl text-c color6"><span <?php if(($type) == "1"): ?>class='active'<?php endif; ?>>待付款</span></a>
                <a href="<?php echo U('App/Vip/orderList',array('sid'=>0,'type'=>2));?>" class="fl text-c color6"><span <?php if(($type) == "2"): ?>class='active'<?php endif; ?>>待收货</span></a>
                <a href="<?php echo U('App/Vip/orderList',array('sid'=>0,'type'=>3));?>" class="fl text-c color6"><span <?php if(($type) == "3"): ?>class='active'<?php endif; ?>>已完成</span></a>
    </div>
    <div class="home-cc">
       <!--  <?php if(($showfather) == "1"): ?><div class="home-lst border-b1 border-t1 ovflw back2" style="text-align: center">您是由【<?php echo ($father["nickname"]); ?>】推荐</div><?php endif; ?> -->
        ...
        <div class="home-lst border-b1 border-t1 ovflw back2">
            ...
            <span class="home-tt color6">我的佣金：<?php echo ($data["money"]); ?></span>
         ...
         <div class="home-lst2 border-b1 border-t1 back2 ovflw">
                    <a href="<?php echo U('App/Fx/index');?>" class="ovflw home-li">
                        ...
                        <span class="home-tt color6">分销中心</span>
