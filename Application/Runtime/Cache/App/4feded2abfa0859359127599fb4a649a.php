...
<body class="back1">
		<div class="mr-b back2">
			...
			<div class="dtl-c border-b1 ovflw fonts9">
				...
				<div class="dtl-prc border-b1">
					<em class="dtl-prc1 color3">团购价:￥<i id="goods-price"><?php echo ($cache["price"]); ?></i></em><em class="color3"></em>&nbsp;&nbsp;<em class="dtl-prc2">原价:￥<?php echo ($cache["oprice"]); ?></em>
					<div class="zandiv"><button id="gbtn" class="zan-btn" type="button" onclick="addnumber(<?php echo ($cache['id']); ?>)"></button>
					<span id="add_num"><?php echo ($cache["zan"]); ?></span>人喜欢</div><br/>
				<div class="fr dtl-sel">团购总量:<?php echo ($cache["minnumber"]); ?>件</div>
		...
		<div class="dtl-prt back2 mr-b fonts9 border-t1 border-b1">
			...
			<div class="ovflw dtl_num fl">
				...
				<input type="text" value="1" style="width:30%;color: black;" class="fl dtl_input dtl_mar1" id="goods-total" disabled="disabled"/>
				<a href="#" class="" style="width: 22%" id="goods-add">+</a>
			</div>
			<span class="fr dtl-sy">团购剩余:<em id="goods-num"><?php echo ($cache['minnumber']-$cache['buygoodsnum']); ?></em>件</span>
		...
		<div class="dtl-ft ovflw">
			...
			<div class="dtl-btns">
				<a href="#" class="fl dtl-btn dtl-buy" id="fastbuy">立即团购</a>
        ...
        console.log(id);
                ...
                var zan=$('#add_num').text();
                 zan =  parseInt(zan)+1;
                 $("#add_num").text(zan).addClass("scale");
                 $("#gbtn").attr("disabled", true);                
    }		
		</script>
		<!--全局封装-->
		<script type="text/javascript">
			var goodsid="<?php echo ($cache["tpid"]); ?>";
		...
		<!--封装SKU-->
		<script type="text/javascript">
			var goodsid="<?php echo ($cache["ptid"]); ?>";
...
<script type="text/javascript">
       function addzan(zan){
          console.log(zan);
            var num=$('#add_num').text();
             num =  parseInt(num)+1;
             $("#add_num").text(num).addClass("scale");
             setTimeout(function(){$("#add_num").removeClass("scale");},2000)
