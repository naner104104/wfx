       ...
       <div class="lv-search search">
        ...
        <form id="key_search" method="post" action="<?php echo U('App/Shop/search/');?>">
            ...
            <input type="submit" value="搜索" class="btn" />
              ...
              <div class="like">
                <ul>
                  <?php if(is_array($cate)): $i = 0; $__LIST__ = $cate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>   		 
                		<div <?php if(($vo["ison"]) == "1"): ?>class="ui-imgs indexiconson"
                            <?php else: ?>class="ui-imgs indexiconsoff"<?php endif; ?> style="border-radius:50%;margin-top:8px;background-image: url('<?php echo ($vo["iconurl"]); ?>');" id="ui-imgs">
                        </div>
